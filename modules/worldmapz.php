...
/***********************************************
 ...
 Updates & Maintenance by: Cousjath - cousjath@yahoo.co.uk
 http://www.dragonprime.net
 Updated: Feb 23, 2008
 ************************************************/

require_once('modules/worlmapz/lib.php');

function worlmapz_getmoduleinfo(){
	$info = array(
	"name"=>"World Map",
	"version"=>"0.9x",
	...
	"settings"=>array(
		...
		"colorCave"=>"Color of earth?,text|#000000",
		"colorRoad"=>"Color of roads?,text|#964B00",
		...
		"encounterCave"=>"Chance of encountering a monster when under surface?,int|1",
		"encounterRoad"=>"Chance of encountering a monster when on a road?,int|"
		...
		"moveCostCave"=>"Movement costs for crossing earth?,int|1000",
	...
	"prefs"=>array(
		...
		"canfly"=>"Can the player fly?,bool|0",
	),
	"prefs-mounts"=>array(
		...
		"encounterCave"=>"Encounter rate for crossing earth?,float|1",
		"encounterRoad"=>"Encounter rate for crossing road,float|1"
...
function worlmapz_install(){
	return true;

function worlmapz_uninstall(){
	
}

function worlmapz_run() {
	require_once('modules/worlmapz/run.php');
	return worlmapz_run_real();
}

function worlmapz_editor() {
	require_once('modules/worlmapz/editor.php');
	return worlmapz_editor_real();
}

function worlmapz_dohook($hookname,$args){
	global $session;
	...
	if (file_exists("modules/worlmapz/dohook/{$hookname}.php")) {
		require("modules/worlmapz/dohook/{$hookname}.php");
	} else {
